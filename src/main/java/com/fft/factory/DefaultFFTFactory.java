 ...
 * 
 * <p>
 * This factory provides automatic selection of the most appropriate FFT
 * implementation
 * based on input size. It maintains a registry of implementations with
 * priority-based
 * selection when multiple implementations are available for the same size.
 * </p>
 * 
 ...
 * <li>Fall back to the generic FFTBase implementation if no optimized version
 * exists</li>
 * </ol>
 * 
 * <h3>Thread Safety:</h3>
 ...
 * threads.
 * Registration operations are synchronized to ensure consistency.
 * </p>
 * 
...
public class DefaultFFTFactory implements FFTFactory {
     ...
     * This method registers known implementations and provides fallback
     * implementations.
     */
