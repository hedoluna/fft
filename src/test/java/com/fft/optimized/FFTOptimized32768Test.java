...
/**
 * Test suite for FFTOptimized32768.
 */
@DisplayName("FFTOptimized32768 Tests")
class FFTOptimized32768Test {

    private FFTOptimized32768 fft;
    private static final int SIZE = 32768;
    private static final double TOLERANCE = 1e-10;

    @BeforeEach
    void setUp() {
        fft = new FFTOptimized32768();
    }
    ...
    void shouldReturnCorrectSupportedSize() {
        ...
        assertThat(fft.supportsSize(16384)).isFalse();
        assertThat(fft.supportsSize(65536)).isFalse();
    }
