 ...
 * 
 * <p>Tests the real-time pitch detection functionality including audio processing,
 * FFT analysis, pitch detection algorithms, and Parsons code generation.</p>
 * 
...
class PitchDetectionDemoTest {
    ...
    class AudioProcessingTests {
        ...
        void shouldConvertBytesToSamplesCorrectly() throws Exception {
            ...
            buffer[0] = 0x00; buffer[1] = 0x10; // Sample 1: 4096
            buffer[2] = 0x00; buffer[3] = (byte)0x20; // Sample 2: 8192  
            buffer[4] = 0x00; buffer[5] = (byte)0x80; // Sample 3: -32768
            buffer[6] = (byte)0xFF; buffer[7] = 0x7F; // Sample 4: 32767
        ...
        void shouldHandleZeroPaddingInByteConversion() throws Exception {
            ...
            buffer[0] = 0x00; buffer[1] = 0x10; // Sample 1
            buffer[2] = 0x00; buffer[3] = 0x20; // Sample 2
    ...
    class PitchDetectionAlgorithmTests {
        ...
        void shouldFindFundamentalFrequencyFromHarmonics() throws Exception {
            ...
            if (fundamentalBin < magnitudes.length) magnitudes[fundamentalBin] = 0.8;
            if (secondHarmonicBin < magnitudes.length) magnitudes[secondHarmonicBin] = 1.0;
